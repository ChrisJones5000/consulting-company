...
var _SlickSlider = __webpack_require__(5);
...
// new Slider();
new _SlickSlider2.default((0, _jquery2.default)('.slider'));
...
var MobileMenu = function () {
	function MobileMenu() {
		...
		this.infoContent = (0, _jquery2.default)('.site-header__info-container');
		this.events();
	}
...
var RevealOnScroll = function () {
	function RevealOnScroll(els, animation, offsetPercentage) {
			...
			this.itemsToReveal.each(function () {
				...
				new Waypoint({
					...
					handler: function handler() {
						(0, _jquery2.default)(currentItem).addClass(that.cssClass + '--is-visible');
					},
